...
class InverseKinematicsForPoseRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InverseKinematicsForPoseRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InverseKinematicsForPoseRequest
    let len;
    let data = new InverseKinematicsForPoseRequest(null);
  ...
  static datatype() {
    ...
    return 'custom_msgs/InverseKinematicsForPoseRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InverseKinematicsForPoseRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class InverseKinematicsForPoseResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.q1 = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InverseKinematicsForPoseResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InverseKinematicsForPoseResponse
    let len;
    let data = new InverseKinematicsForPoseResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'custom_msgs/InverseKinematicsForPoseResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InverseKinematicsForPoseResponse(null);
    if (msg.q1 !== undefined) {
      resolved.q1 = msg.q1;
    }
    else {
...
module.exports = {
  Request: InverseKinematicsForPoseRequest,
  Response: InverseKinematicsForPoseResponse,
  md5sum() { return '64e345b87f38099c3cc1cc7c03cb146a'; },
  datatype() { return 'custom_msgs/InverseKinematicsForPose'; }
};
